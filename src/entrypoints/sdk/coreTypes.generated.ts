/**
 * Core types derived from @anthropic-ai/claude-agent-sdk sdk.d.ts
 *
 * These provide the exact type surface so users can switch between
 * the official SDK and Open Agent SDK without changing imports.
 */
...
// ---------------------------------------------------------------------------
// ApiKeySource / ExitReason / ConfigScope / SdkBeta
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Additional types exported by the official SDK
// ---------------------------------------------------------------------------
...
export type McpServerConfig =
  ...
  | McpSSEServerConfig
  | McpHttpServerConfig
  | import('./runtimeTypes.js').McpSdkServerConfigWithInstance
